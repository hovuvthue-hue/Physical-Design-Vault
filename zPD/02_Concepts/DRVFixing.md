...
used_by: [PreCTSOptimization, Placement, ClockTreeSynthesis, Signoff]
...
## Definition
**DRVFixing** là hoạt động sửa các vi phạm design rule dạng điện (electrical DRV) được phát hiện sau [[Placement]] và trước [[ClockTreeSynthesis]].

Mục tiêu là đưa design về trạng thái “khỏe điện” hơn trước khi đi tiếp sang CTS và các bước downstream.
...
## Why DRV fixing matters before CTS
...
Vì vậy DRVFixing thường là một phần quan trọng của pre-CTS cleanup.
