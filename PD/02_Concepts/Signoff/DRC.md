...
used_by: [DetailedRouting, Routing, ChipFinishing, DFM, Signoff]
...
## Relation to DFM and ChipFinishing
[[DFM]] mở rộng góc nhìn từ DRC rule-compliance sang manufacturability robustness. Vì vậy DRC-clean là điều kiện quan trọng, nhưng không đồng nghĩa với bảo đảm yield hoặc bao phủ toàn bộ DFM concerns. [Needs verification]

[[ChipFinishing]] dùng DRC context để hoàn thiện routed layout trước signoff, ví dụ cleanup các vấn đề geometry còn lại hoặc chuẩn bị layout cho các checks downstream. Chính sách cụ thể vẫn phụ thuộc rule deck và signoff methodology. [Needs verification]
...
- [[ChipFinishing]] — dùng DRC context cho cleanup/readiness trước signoff.
- [[DFM]] — dùng DRC như nền rule-compliance nhưng không giới hạn ở DRC.
...
→ Manufacturing-related: [[AntennaEffect]] · [[ChipFinishing]] · [[DFM]]
