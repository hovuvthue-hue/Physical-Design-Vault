...
## Liên hệ clock modeling trong STA
- [[VirtualClock]] thường làm timing reference cho các I/O paths.
- [[GeneratedClock]] giúp STA hiểu đúng quan hệ clock dẫn xuất từ master clock để check timing chính xác.
