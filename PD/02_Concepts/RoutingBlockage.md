...
used_by: [GlobalRouting, DetailedRouting, Routing, MacroPlacement, Floorplanning]
...
## Constrains
- **[[GlobalRouting]]**: RoutingBlockage làm giảm hoặc loại bỏ supply trên vùng/layer bị chặn, nên route plan phải tránh hoặc phân bổ demand sang tài nguyên khác
- **[[DetailedRouting]]**: Router không được đặt wire/via geometry trên blocked layers trong vùng RoutingBlockage; phải route qua các layers không bị block hoặc đi vòng qua vùng khác
...
## Used by
- [[GlobalRouting]] — đọc RoutingBlockage khi ước lượng resource availability và congestion risk
- [[DetailedRouting]] — tôn trọng RoutingBlockage khi tạo legal wire/via geometry
...
→ Consumed by: [[GlobalRouting]] · [[DetailedRouting]] · [[Routing]] · [[Floorplanning]]
