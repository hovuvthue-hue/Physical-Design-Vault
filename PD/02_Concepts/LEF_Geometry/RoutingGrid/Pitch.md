...
- **[[RoutingGrid]]**: toàn bộ Routing Grid được xây dựng bằng cách đặt các Tracks cách nhau đúng một Pitch; Pitch nhỏ hơn thường cho nhiều Tracks hơn trên cùng diện tích, nhưng cũng làm tradeoff congestion/coupling nhạy hơn ở các vùng demand cao; coupling chỉ là một thành phần khái niệm của [[InterconnectRC]] sau extraction
...
→ Affects: Routing capacity/congestion tradeoff · [[InterconnectRC]] · coupling behavior
